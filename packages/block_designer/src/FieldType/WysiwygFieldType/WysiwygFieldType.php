...
class WysiwygFieldType extends FieldType
{
    ...
    public function getRepeatableUpdateItemJS()
    {
        ...
        return '$(newField).find(\'textarea.' . $class . '\').redactor({
    ...
    ' . parent::generateFormContent('editor', array('slug' => $this->data['slug'], 'parent' => isset($this->data['parent']) ? $this->data['parent'] : null, 'attributes' => array('class' => $this->getRepeatableUpdateItemJSClassName())), $repeating) . '
</div>';
        return $return;
    }
