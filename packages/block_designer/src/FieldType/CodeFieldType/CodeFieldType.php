...
class CodeFieldType extends FieldType
{
    ...
    ' . parent::generateFormContent('textarea', array('slug' => $this->data['slug'], 'parent' => isset($this->data['parent']) ? $this->data['parent'] : null, 'attributes' => array('rows' => 5), 'escape' => false), $repeating) . '
</div>';
    }
