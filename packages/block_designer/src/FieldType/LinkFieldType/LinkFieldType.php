...
?>' . $this->data['suffix'] . '<?php  } ?>';
    ...
    ' . parent::generateFormContent('label', array('slug' => $this->data['slug'] . '_text', 'parent' => isset($this->data['parent']) ? $this->data['parent'] : null, 'label' => $this->data['label'], 'suffix' => ' . " " . t("Text")'), $repeating) . '
