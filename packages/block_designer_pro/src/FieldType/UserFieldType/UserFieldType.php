...
class UserFieldType extends FieldType
{
    ...
    protected $dbType = 'I';
    protected $uses = array('UserList', 'UserInfo');
    ...
    public function getAddEditFunctionContents()
    {
        ...
        $lines = array('$' . $this->data['slug'] . '_options = array();
    ...
    ' . parent::generateFormContent('select', array('slug' => $this->data['slug'], 'parent' => isset($this->data['parent']) ? $this->data['parent'] : null, 'options' => $options), $repeating) . '
</div>';
    }
