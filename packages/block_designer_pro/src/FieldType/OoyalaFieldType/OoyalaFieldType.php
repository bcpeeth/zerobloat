...
class OoyalaFieldType extends FieldType
{
    ...
    public function getViewContents()
    {
        ...
        if (isset($this->data['tvRatingsPosition']) && is_string($this->data['tvRatingsPosition']) && in_array($this->data['tvRatingsPosition'], array('top-left', 'top-right', 'bottom-left', 'bottom-right'))) {
        ...
        if (isset($this->data['tvRatingsTimer']) && is_string($this->data['tvRatingsTimer']) && in_array($this->data['tvRatingsTimer'], array('always', 'never', 'custom'))) {
