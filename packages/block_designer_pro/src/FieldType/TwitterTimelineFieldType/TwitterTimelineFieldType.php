...
class TwitterTimelineFieldType extends FieldType
{
    ...
    public function getViewContents()
    {
        ...
        if (isset($this->data['theme']) && in_array($this->data['theme'], array('dark'))) {
        ...
        if (isset($this->data['politeness']) && in_array($this->data['politeness'], array('assertive'))) {
    ...
    public function getFormContents()
    {
        ...
        $fieldAttributes = array('maxlength' => 255);
