...
class FontAwesomeFieldType extends FieldType
{
    ...
    public function getAddEditFunctionContents()
    {
        ...
        if ($repeating) {
            return '$' . $this->data['parent']['slug'] . '[\'' . $this->data['slug'] . '_options\'] = ' . ('(!in_array("' . $this->data['slug'] . '", ' . $btFieldsRequired . ') ? array("" => "-- " . t("None") . " --") : array())') . ' + $this->fontAwesomeIcons(\'' . ($this->selectedFontAwesomeVersion()) . '\');';
        } else {
            return '$this->set(\'' . $this->data['slug'] . '_options\', ' . ('(!in_array("' . $this->data['slug'] . '", ' . $btFieldsRequired . ') ? array("" => "-- " . t("None") . " --") : array())') . ' + $this->fontAwesomeIcons(\'' . ($this->selectedFontAwesomeVersion()) . '\'));';
        }
    }
    ...
    $(document).ready(function () {
        ...
        $attributes = array('class' => 'form-control font-awesome-previewed');
    ...
    ' . ($showPreview ? '    ' : null) . parent::generateFormContent('select', array('slug' => $this->data['slug'], 'parent' => isset($this->data['parent']) ? $this->data['parent'] : null, 'options' => $options, 'attributes' => $attributes), $repeating) . '
