...
class PageAttributeFieldType extends FieldType
{
    ...
    {
        return parent::view('field_options.php', 'block_designer_pro', array('pageAttributes' => $this->getPageAttributes()));
    }
    ...
    ' . parent::generateFormContent('page_selector', array('slug' => $this->data['slug'], 'parent' => isset($this->data['parent']) ? $this->data['parent'] : null, 'attributes' => array('class' => 'page_attribute-ft')), $repeating);
            $html .= '</div>';
            return $html;
        }
    }
