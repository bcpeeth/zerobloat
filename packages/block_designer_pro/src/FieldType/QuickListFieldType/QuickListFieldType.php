...
class QuickListFieldType extends FieldType
{
    ...
    public function getSearchableContent()
    {
        ...
        '. $repeatingTab . '$' . $this->data['slug'] . '_options = array();
    ...
    public function getViewContents()
    {
        ...
        $tag = isset($this->data['list_type']) && in_array($this->data['list_type'], array('ul', 'ol')) ? $this->data['list_type'] : 'ul';
