...
<div class="container">
  <div class="row flex-center py-5">
    ...
    <div class="col-md-6 img-block img-block-reduce">
      <img class="logo" src="<?php echo $view->getThemePath(); ?>/assets/images/Tekengebied.png">
    </div>
  </div>
</div>
<div class="bg-blue">
...
<div class="container">
  <div class="row flex-center py-5">
    <div class="col-md-6 img-block">
      <img class="logo" src="<?php echo $view->getThemePath(); ?>/assets/images/method-image.png">
    </div>
    <div class="col-md-6">
  ...
  <div class="container">
    <div class="row flex-center py-3">
      ...
      <div class="col img-block img-block-reduce">
        <img class="logo" src="<?php echo $view->getThemePath(); ?>/assets/images/au2.png">
      </div>
    </div>
...
<div class="container text-center">
  ...
  <div class="row board-members py-5">
    <div class="col">
      <img class="logo" src="<?php echo $view->getThemePath(); ?>/assets/images/board-member1.png">
      <h6>Rini Tak</h6>
      <p><span>Voorzitter</span></p>
      <p>Vanuit zijn passie al jarenlang betrokken bij diverse stichtingen.</p>
    </div>
    <div class="col">
      <img class="logo" src="<?php echo $view->getThemePath(); ?>/assets/images/board-member2.png">
      <h6>Patty van Veldhuizen</h6>
        <p><span>Penningmeester</span></p>
      <p>Als fiscalist altijd de focus op financieel beheer.</p>
    </div>
    <div class="col">
      <img class="logo" src="<?php echo $view->getThemePath(); ?>/assets/images/board-member3.png">
    ...
    <div class="col">
      <img class="logo" src="<?php echo $view->getThemePath(); ?>/assets/images/board-member4.png">
    ...
    <div class="col">
      <img class="logo" src="<?php echo $view->getThemePath(); ?>/assets/images/board-member5.png">
      <h6>Remko Overdam</h6>
